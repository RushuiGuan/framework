...
namespace Albatross.CodeGen.CommandLine {
	...
	[Verb("csharp-proxy-restclient", typeof(CSharpWebClientCodeGenCommandHandler_RestClient), Description = "Generate CSharp Http Proxy class that works with the current version of Albatross.RestClient assembly")]
