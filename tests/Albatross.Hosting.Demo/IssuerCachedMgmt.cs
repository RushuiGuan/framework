...
namespace Albatross.Hosting.Test {
	public class IssuerCachedMgmt : CacheManagement<string[]> {
		...
		public IssuerCachedMgmt(ILogger logger, IPolicyRegistry<string> registry, IAsyncCacheProviderConverter cacheProvider, IRedisKeyManagement keyMgmt) : base(logger, registry, cacheProvider, keyMgmt) {
		}
