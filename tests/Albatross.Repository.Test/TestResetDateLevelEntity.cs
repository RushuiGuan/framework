...
namespace Albatross.Repository.Test {
	public class TestResetDateLevelEntity {
		...
		public async Task ResetTimeSeries1() {
			...
			await new TickSize(1, Values.Apr1_2022, 500).SetDateLevel<TickSize, int>(set.Object, list.Add, args => list.Remove(args), true);
		...
		public async Task ResetTimeSeries2() {
			...
			await new TickSize(1, Values.Mar1_2022, 100).SetDateLevel<TickSize, int>(set.Object, list.Add, args => list.Remove(args));
			await new TickSize(1, Values.Jul1_2022, 200).SetDateLevel<TickSize, int>(set.Object, list.Add, args => list.Remove(args));
			await new TickSize(1, Values.Sep1_2022, 300).SetDateLevel<TickSize, int>(set.Object, list.Add, args => list.Remove(args), true);
