...
namespace Albatross.CodeGen.CommandLine {
	public class CSharpWebClientCodeGenCommandHandler_RestClient : BaseHandler<CodeGenCommandOptions> {
		private readonly CreateHttpClientRegistrations createHttpClientRegistrations;
		private readonly Compilation compilation;
		private readonly CodeGenSettings settings;
		private readonly ILogger<CSharpWebClientCodeGenCommandHandler_RestClient> logger;
		private readonly ConvertApiControllerToControllerModel convertToWebApi;
		private readonly ConvertWebApiToCSharpCodeStack_RestClient converToCSharpCodeStack;

		public CSharpWebClientCodeGenCommandHandler_RestClient(IOptions<CodeGenCommandOptions> options,
			CreateHttpClientRegistrations createHttpClientRegistrations,
			Compilation compilation,
			CodeGenSettings settings,
			ILogger<CSharpWebClientCodeGenCommandHandler_RestClient> logger,
			ConvertApiControllerToControllerModel convertToWebApi,
			ConvertWebApiToCSharpCodeStack_RestClient converToCSharpFile) : base(options) {
