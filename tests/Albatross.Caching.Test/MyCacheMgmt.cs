...
namespace Albatross.Caching.Test {
	public class MyCacheMgmt : CacheManagement<string> {
		public MyCacheMgmt(ILogger<MyCacheMgmt> logger, IPolicyRegistry<string> registry, IAsyncCacheProvider cacheProvider, IMemoryCache cache) : base(logger, registry, cacheProvider, cache) {
		}
