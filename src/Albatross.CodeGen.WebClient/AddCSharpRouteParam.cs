...
namespace Albatross.CodeGen.WebClient {
	public class AddCSharpRouteUrl : ICodeElement {
		...
		public readonly static Regex ParamRegex = new Regex(@"{(([a-z_]+[a-z0-9_]*)?date[0-9]*)}|{(\*\*)?([a-z_]+[a-z0-9_]*)}", RegexOptions.Singleline | RegexOptions.IgnoreCase | RegexOptions.IgnorePatternWhitespace);
