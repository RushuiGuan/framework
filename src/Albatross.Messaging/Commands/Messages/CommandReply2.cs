...
namespace Albatross.Messaging.Commands.Messages {
	public record class CommandReply2 : CommandMessage {
		public static string MessageHeader => "cmd-rep2";
		public byte[] Payload { get; private set; } = Array.Empty<byte>();

		public CommandReply2(string route, ulong id, string commandType, byte[] payload) : base(MessageHeader, route, id, commandType) {
			Payload = payload;
		}
		public CommandReply2() { }
