# Albatross Framework
Albatross is a .Net development framework that allow developers to quickly bootstrap an application with cross cutting functionaties such as logging, caching and config management.  It builds intergration points to other libraries so that developers can work with a consistant platform without having to solve the same technical problems repeatly.
...
|Command line utility (legacy)|CommandLineParser|Albatross.Hosting.Utility|
|Command line utility (New) | System.CommandLine | Albatross.CommandLine|
...
|Albatross.CommandLine|Bootstrapping assembly for creating a command line console program (New)|Net6/7/8|
|Albatross.SpecFlowPlugin|SpecFlow Plugin host with Microsoft Dependency Injection and Serilog logging|netstandard2.0|
...
|Albatross.Caching.MemCache|Memory Cache implementation|NetStandard2.1|
|Albatross.CodeGen|CodeGen base library|Net8.0|	
|Albatross.CodeGen.TypeScript|CodeGen library for TypeScript|Net8.0|	
|Albatross.CodeGen.WebClient|CodeGen library for Generating WebApi Proxy|Net6/7/8|
|Albatross.CodeGen.CommandLine|CodeGen Tool for Generating WebApi Proxy|Net8|
