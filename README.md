...
|[config](./config/Albatross.Config)|Simplfied configuration setup for your .Net applications.|[![NuGet Version](https://img.shields.io/nuget/v/https://www.nuget.org/packages/Albatross.Config)]()|
|datelevel|||
|dates|||
|efcore|||
